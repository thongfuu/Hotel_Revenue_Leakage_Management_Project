...
- ชื่อกราฟ2: เจาะลึกช่วงเวลาการยกเลิกและมูลค่าความเสียหายจริง
- การแสดงผล:
...
Graph3: Horizontal Stacked Bar Chart
- ชื่อกราฟ: พฤติกรรมช่วงเวลาที่ยกเลิกแยกตามช่องทาง
- การแสดงผล:
...
- เหตุผลที่เลือกใช้:
สามารถแสดงข้อมูล 4 มิติพร้อมกันในกราฟเดียว

![H5_graph1](docs/images/H5_graph5.1.png)


Graph2: Heatmap
- ชื่อกราฟ: Risk Heatmap - ช่องทางจอง vs นโยบาย (Domestic & Short-haul)
- การแสดงผล:
...
- เหตุผลที่เลือกใช้:
เปรียบเทียบความเสี่ยงหลายปัจจัยพร้อมกันได้ง่าย

![H5_graph2](docs/images/H5_graph5.2.png)
...
- เหตุผลที่เลือกใช้:
เปรียบเทียบ 3 กลุ่มช่วยให้เห็น "ความอันตรายที่แท้จริงต่อหัว" ของลูกค้าแต่ละประเภทได้อย่างชัดเจน

![H6_graph1](docs/images/H6_graph6.1.png)

Graph2: Pie Chart
- ชื่อกราฟ: สัดส่วนความเสียหายรวม แยกตามกลุ่มลูกค้า (Hypothesis Rejected)
- การแสดงผล:
...
- เหตุผลที่เลือกใช้:
เหมาะสำหรับแสดงให้เห็นว่าความเสียหาย "กระจายตัว"

![H6_graph2](docs/images/H6_graph6.2.png)
...
- เหตุผลที่เลือกใช้:
ช่วยให้เห็นทั้งค่าตัวเลขรายกลุ่มและทิศทางแนวโน้มในคราวเดียว

![H7_graph1](docs/images/H7_graph7.1.png)

Graph: Hexbin Plot
- ชื่อกราฟ: ความสัมพันธ์ระหว่าง “วันจอง” กับ “วันยกเลิก”
- การแสดงผล:
...
![H7_graph2](docs/images/H7_graph7.2.png)
...
- เหตุผลที่เลือกใช้:
แสดงให้เห็นรูปแบบ (Pattern) ความเสียหายรายวันได้ชัดเจน

![H8_graph1](docs/images/H8_graph8.1.png)
