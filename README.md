...
- [fact_bookings](Datasets\fact_bookings.csv)
- [dim_calendar](Datasets\dim_calendar.csv)
- [dim_channels](Datasets\dim_channels.csv)
- [dim_guests](Datasets\dim_guests.csv)
- [dim_policies](Datasets\dim_policies.csv)
- [dim_rate_codes](Datasets\dim_rate_codes.csv)
- [dim_reason_cancellations](Datasets\dim_reason_cancellations.csv)
- [dim_room_inventory](Datasets\dim_room_inventory.csv)
- [dim_roomtype](Datasets\dim_roomtype.csv)
- [fact_marketing_spend](Datasets\fact_marketing_spend.csv)
